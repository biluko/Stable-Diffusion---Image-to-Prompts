...
IMG_PATH = '/root/SDIP/data/image211k/'#211k图片路径
CSV_PATH = '/root/SDIP/data/prompts/sd2_meta_211k_filter.csv'#211k csv文件路径

IMG_PATH_540kP1 = '/root/SDIP/data/image540kp1/'#540kp1 图片路径
CSV_PATH_540kP1 = '/root/SDIP/data/prompts/sd2_meta_540k_part1.csv'#540kp1 csv文件路径
IMG_PATH_540kP2 = '/root/SDIP/data/images540kp2/'#540kp2 图片路径
CSV_PATH_540kP2 = '/root/SDIP/data/prompts/sd2_meta_540k_part2.csv'#540kp2 csv文件路径

IMG_PATH_660kP1 = '/root/SDIP/data/images660kp1/'#660kp1 图片路径
CSV_PATH_660kP1 = '/root/SDIP/data/prompts/sd2_meta_cc660k_part1.csv'#660kp1 csv文件路径
IMG_PATH_660kP2 = '/root/SDIP/data/images660kp2/'#660kp2 图片路径
CSV_PATH_660kP2 = '/root/SDIP/data/prompts/sd2_meta_cc660k_part2.csv'#660kp2 csv文件路径

IMG_PATH_Pszemraj = '/root/SDIP/data/imagesPszemraj/'#Pszemraj图片路径
CSV_PATH_Pszemraj = '/root/SDIP/data/prompts/sd2_meta_pszemraj.csv'#Pszemraj csv文件路径

IMG_PATH_Hard = '/root/SDIP/data/imagesHard/'#Hard图片路径
CSV_PATH_Hard = '/root/SDIP/data/prompts/sd2_meta_hard_filter.csv'#Hard csv文件路径

IMG_PATH_laincocop1 = '/root/SDIP/data/imagesLaioncocop1/'#Hard图片路径
CSV_PATH_laioncocop1 = '/root/SDIP/data/prompts/sd2_meta_laioncoco_p1.csv'#Hard csv文件路径

IMG_PATH_laincocop2 = '/root/SDIP/data/imagesLaioncocop2/'#Hard图片路径
CSV_PATH_laioncocop2 = '/root/SDIP/data/prompts/sd2_meta_laioncoco_p2.csv'#Hard csv文件路径
